...
VL_ATTR_COLD void Vlng___024root___ctor_var_reset(Vlng___024root* vlSelf) {
    ...
    vlSelf->signal_in = VL_RAND_RESET_I(1);
    vlSelf->temperature_output = VL_RAND_RESET_I(9);
    vlSelf->PulseDurationMeasurement__DOT__state = VL_RAND_RESET_I(2);
    vlSelf->PulseDurationMeasurement__DOT__count = VL_RAND_RESET_I(12);
    vlSelf->PulseDurationMeasurement__DOT__pulse_duration = VL_RAND_RESET_I(12);
    vlSelf->PulseDurationMeasurement__DOT__temp_value1 = VL_RAND_RESET_I(9);
